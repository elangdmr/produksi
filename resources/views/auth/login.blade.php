...
<a class="brand-logo d-flex align-items-center text-decoration-none" href="#">
  <img src="{{ asset('app-assets/images/logo/logo.png') }}" alt="Logo" class="me-2" style="height:100px; width:auto;">
              ...
              <form class="auth-register-form mt-2" action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-1">
                  ...
                  <input class="form-control" id="email" type="email" name="email"
                         placeholder="asep@example.com" aria-describedby="email"
                ...
                <button class="btn btn-danger w-100" tabindex="5" type="submit">Login</button>
              </form>
            </div>
          </div>
          <!-- /Right -->
