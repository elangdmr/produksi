          ...
          <div class="col-lg-4 col-md-4 col-6">
            <div class="card text-center">
              <div class="card-body">
                ...
                <h2 class="fw-bolder">{{ $requests }}</h2>
          ...
          <div class="col-lg-4 col-md-4 col-6">
            <div class="card text-center">
              <div class="card-body">
                ...
                <h2 class="fw-bolder">{{ $approved }}</h2>
            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                <div class="d-flex flex-row">
                  <div class="avatar bg-light-info me-2">
                    <div class="avatar-content"><i data-feather="users" class="avatar-icon"></i></div>
                  </div>
                  <div class="my-auto">
                    <h4 class="fw-bolder mb-0">{{ $adminCount }}</h4>
              ...
              <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                <div class="d-flex flex-row">
                  ...
                  <div class="my-auto">
                    <h4 class="fw-bolder mb-0">{{ $ppicCount }}</h4>
              ...
              <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                <div class="d-flex flex-row">
                  ...
                  <div class="my-auto">
                    <h4 class="fw-bolder mb-0">{{ $rndCount }}</h4>
              ...
              <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                <div class="d-flex flex-row">
                  ...
                  <div class="my-auto">
                    <h4 class="fw-bolder mb-0">{{ $purchasingCount }}</h4>
