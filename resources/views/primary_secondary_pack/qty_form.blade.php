    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-header">
          <h4 class="card-title">Input Qty Batch</h4>
        ...
        <div class="card-body">
          <form action="{{ route('primary-secondary.qty.save', $batch->id) }}" method="POST">
            @csrf
            ...
            <div class="mb-1">
              ...
              <input type="text"
                     class="form-control"
                     value="{{ optional($batch->tgl_secondary_pack_1)->format('d-m-Y') }}"
                     disabled>
            </div>
            ...
            <div class="mt-2 d-flex justify-content-between">
              <a href="{{ route('primary-secondary.index') }}" class="btn btn-outline-secondary">
                Kembali
              </a>
