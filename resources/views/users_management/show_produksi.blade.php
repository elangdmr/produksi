        ...
        <div class="table-responsive">
          <table class="table mb-0">
            ...
            <tbody>
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('edit-produksi', ['id' => $user->id]) }}">
                          <i data-feather="edit-2" class="me-50"></i><span>Edit</span>
                        </a>
                        <form action="{{ route('delete-produksi', ['id' => $user->id]) }}"
                              method="POST"
              ...
              @empty
                <tr>
                  <td colspan="4" class="text-center text-muted">Belum ada akun Produksi</td>
                </tr>
              @endforelse
            </tbody>
          </table>
