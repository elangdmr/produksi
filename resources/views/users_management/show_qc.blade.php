    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
          <h4 class="card-title">Daftar Akun QC</h4>
          <div>
        ...
        <div class="modal fade text-start" id="inlineForm" tabindex="-1" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <form action="{{ url('/show-qc') }}" method="POST">
                @csrf
        ...
        <div class="table-responsive">
          <table class="table mb-0">
            ...
            <tbody>
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('edit-qc', ['id' => $user->id]) }}">
                          <i data-feather="edit-2" class="me-50"></i><span>Edit</span>
                        </a>
                        <form action="{{ route('delete-qc', ['id' => $user->id]) }}"
                              method="POST"
              ...
              @empty
                <tr>
                  <td colspan="4" class="text-center text-muted">Belum ada akun QC</td>
                </tr>
              @endforelse
            </tbody>
          </table>
